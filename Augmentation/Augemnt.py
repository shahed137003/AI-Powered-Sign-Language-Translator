# ============================================================
# MEMORY-EFFICIENT LANDMARK AUGMENTATION FOR SIGN LANGUAGE
# AUGMENTATION ONLY - NO MASKS, NO BALANCING
# ============================================================
...
class MemoryEfficientAugmenter:
    ...
    def augment_single(self, sequence: np.ndarray,
        ...
        for aug_type in augmentation_types:
            if aug_type == 'speed':
                result = self.apply_speed_variance(result)
            elif aug_type == 'shift':
                result = self.apply_hand_shift(result)
            elif aug_type == 'scale':
                result = self.apply_hand_scale(result)
            elif aug_type == 'rotation':
                result = self.apply_hand_rotation(result)
...
def augment_dataset(data: np.ndarray, 
    ...
    Returns:
        augmented_data, augmented_labels (if labels provided)
    """
    # Validate and convert data first
...
# ============================================================
# SIMPLE AUGMENTATION (MOST MEMORY EFFICIENT)
# ============================================================
