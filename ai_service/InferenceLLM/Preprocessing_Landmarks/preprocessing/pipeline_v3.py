...
def preprocess_sequence_global(
    ...
    return out
# Add caching for feature engineering
from functools import lru_cache

@lru_cache(maxsize=32)
def _cached_build_features(seq_tuple):
    """Cache feature engineering results for identical sequences"""
    return build_features(np.array(seq_tuple))