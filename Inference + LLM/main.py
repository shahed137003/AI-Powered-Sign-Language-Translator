...
while cap.isOpened():
    ...
    cv2.putText(frame, f"Gesture: {pred}", (20, 420),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)

    cv2.putText(frame, f"Confidence: {conf:.1f}%", (20, 450),
                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)

    cv2.putText(frame, f"Words: {' '.join(words)}", (20, 380),
                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)

    cv2.putText(frame, f"English: {sentence}", (20, 500),
