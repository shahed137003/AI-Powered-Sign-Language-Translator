...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 lg:gap-6">
        ...
        <NavLink
          ...
          className="
            ...
            bg-gradient-to-r from-[#6A3093] via-[#A044FF] to-[#BF5AE0] dark:from-[#6A3093] dark:to-[#A044FF]
            text-white text-lg px-6 py-2 rounded-full font-semibold
            shadow-lg shadow-purple-500/40 hover:shadow-2xl hover:scale-105
            active:scale-95 transition-all duration-300"
        >
          Login <FaSignInAlt className="text-xl" />
        </NavLink>
        ...
        <button
          ...
          className="
            ...
            bg-gray-300 dark:bg-gray-700 p-0.5 transition-all duration-300 shadow-inner"
        >
          <div
            className={`
      ...
      <div
        className={`
          absolute top-full left-0 w-full bg-white/90 dark:bg-[#0f0c29]/95
          backdrop-blur-lg border-b border-gray-200 dark:border-purple-500/30
      ...
      >
        <div className="flex flex-col items-start px-6 space-y-4">
          {navItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                ...
                ${isActive ? "text-purple-600 font-semibold" : "text-gray-700 dark:text-gray-200"}
          ...
          <NavLink
            ...
            onClick={toggleMobileMenu}
            className="
              relative overflow-hidden group w-full py-3 mt-2 text-center text-xl font-semibold
              bg-gradient-to-r from-[#6A3093] via-[#A044FF] to-[#BF5AE0] dark:from-[#6A3093] dark:to-[#A044FF]
          ...
          >
            ...
            <div
              className="
                absolute top-0 left-0 w-full h-full bg-white/20 translate-y-full
                group-hover:translate-y-0 transition-transform duration-300 rounded-full
              "
            />
          </NavLink>
        </div>
