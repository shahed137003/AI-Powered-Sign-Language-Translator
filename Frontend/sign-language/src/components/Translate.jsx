  ...
  const initializeMediaPipe = () => {
    ...
    holistic.onResults((results) => {
      ...
      if (socketRef.current?.readyState === WebSocket.OPEN) {
        // Always send keypoints - backend decides when to record based on motion
        const keypoints = extractKeypoints(results);
        socketRef.current.send(JSON.stringify({
          type: "keypoints",
          data: keypoints
          // No hands_visible flag needed - motion detection on backend!
        }));
        ...
        //     // Send initial keypoints with hands_visible=true
        //     const keypoints = extractKeypoints(results);
        //     socketRef.current.send(JSON.stringify({
        //       type: "keypoints",
        //       data: keypoints,
        //       hands_visible: true   // ADD THIS
        //     }));
