                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                      ...
                      <div className="flex gap-3 w-full sm:w-auto">
                        <button
                          ...
                          className="flex-1 sm:flex-initial px-6 py-2.5 bg-green-600 hover:bg-green-700 active:scale-95 text-white font-bold rounded-xl shadow-md transition-all text-sm flex items-center justify-center gap-1.5"
                        >
                          Accept & Add
                        </button>
                        <button
                          onClick={handleRejectPrediction}
                          className="flex-1 sm:flex-initial px-6 py-2.5 bg-red-600 hover:bg-red-700 active:scale-95 text-white font-bold rounded-xl shadow-md transition-all text-sm flex items-center justify-center gap-1.5"
                        >
                          Reject / Skip
                        </button>
                      </div>
                  ...
                  <div className="flex justify-between items-end mb-2 border-b border-purple-500/50 pb-2">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button onClick={handleUndo} disabled={!recognizedText}
                        className={`text-sm text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 flex items-center gap-1 font-semibold transition-opacity ${
                          !recognizedText ? "opacity-30 cursor-not-allowed" : "hover:scale-105"
                        }`}>
