...
export default function Features() {
  return (
    ...
    >
      ...
      {/* Ambient glows */}
      <div className="absolute top-1/4 left-0 w-[500px] h-[500px] bg-primary-600/10 rounded-full blur-[120px]" />
      ...
      <div className="relative max-w-7xl mx-auto z-10">
        <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-transparent via-primary-500/40 to-transparent -translate-x-1/2" />
        ...
        {features.map((feature, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <div className="absolute inset-0 bg-primary-500/20 blur-3xl rounded-full scale-75 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                <img
                  src={feature.img}
                  alt={feature.title}
              ...
              <div className="hidden lg:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center">
                <div className="w-8 h-8 rounded-full border border-primary-500/30 bg-primary-bg-2 flex items-center justify-center shadow-[0_0_15px_rgba(160,68,255,0.4)]">
                  <div className="w-3 h-3 bg-gradient-to-r from-primary-custom-1 to-primary-custom-2 rounded-full" />
                </div>
                <div
                  className={`absolute top-1/2 w-12 h-[1px] bg-primary-500/30 ${
              ...
              >
                <div className="relative bg-white/60 dark:bg-white/5 backdrop-blur-xl p-8 rounded-2xl border border-gray-200 dark:border-primary-500/20 shadow-xl hover:border-primary-500/50 transition-all">
                  <h2 className="text-2xl md:text-3xl font-bold mb-4 bg-gradient-to-r from-primary-custom-1 to-primary-custom-2 bg-clip-text text-transparent">
                    {feature.title}
                  </h2>
