        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <motion.span
                ...
                className="block text-transparent bg-clip-text bg-gradient-to-r from-[#6A3093] via-[#A044FF] to-[#BF5AE0] dark:from-[#6A3093] dark:to-[#A044FF] animate-gradient-x"
              >
                Sign Language
              </motion.span>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <motion.button
              ...
              className="relative px-8 py-4 rounded-full bg-gradient-to-r from-[#6A3093] via-[#A044FF] to-[#BF5AE0] dark:from-[#6A3093] dark:to-[#A044FF] text-white font-bold text-lg shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 overflow-hidden group"
            >
