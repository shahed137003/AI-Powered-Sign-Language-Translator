...
></div>
        ...
        >
          ...
          >
            ...
            <motion.span
              ...
              className="block text-transparent bg-clip-text bg-gradient-to-r from-[#6A3093] via-[#A044FF] to-[#BF5AE0]"
            >
              Sign Language
            </motion.span>
          ...
          {/* FEATURE CARD (LIGHT MODE IMPROVED) */}
          <motion.div
            variants={scaleIn}
            className="
              p-4 sm:p-8 rounded-3xl 
              backdrop-blur-3xl 
              bg-white/70 dark:bg-[#1a163a]/60
              border border-white/80 dark:border-white/10
              shadow-xl shadow-purple-200/40 dark:shadow-none
              ...
              {[
                ...
                <motion.div
                  ...
                  className="
                    ...
                    hover:bg-purple-50/70 dark:hover:bg-white/10 
                    transition-all duration-300
                  "
                >
  ...
  // Cleaned up className for readability and ensured 'group' is present
  className="
    relative overflow-hidden px-8 py-4 rounded-full 
    bg-gradient-to-r from-[#6A3093] via-[#A044FF] to-[#BF5AE0]
    text-white font-bold text-lg shadow-lg shadow-purple-400/40 
    hover:shadow-purple-500/60 transition-all group
    focus:outline-none focus:ring-4 focus:ring-purple-500/50 /* Added for accessibility */
  "
>
  {/* The main button content, ensure it has a higher z-index than the overlay */}
  ...
  <div 
    className="
      ...
      z-0 /* Lower z-index than the span content */
      rounded-full
    "
  />
</motion.button>
