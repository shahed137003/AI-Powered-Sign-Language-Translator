...
const filePath = 'd:/GP/Frontend/sign-language/src/components/ForgetPassword.jsx';
...
if (!content.includes('const { themeColor } = useTheme();')) {
  content = content.replace(/export default function ForgetPassword\(\) \{/, `export default function ForgetPassword() {\n  const { themeColor } = useTheme();`);
}
...
console.log('Fixed ForgetPassword.jsx theme');
