...
export default function RotatingEarth({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      context.fillStyle = "#4B0082"; // deep primary ocean
      context.fill();
      context.strokeStyle = "#9B59B6"; // bright primary outline
      ...
      if (landFeatures) {
        ...
        context.beginPath();
        path(graticule());
        context.strokeStyle = "#C39BD3"; // lighter primary
        ...
        context.strokeStyle = "#9B59B6"; // primary land outlines
        context.lineWidth = 1 * scaleFactor;
        context.stroke();
        ...
        allDots.forEach((dot) => {
          ...
          if (
            ...
            context.fillStyle = "#BB8FCE66"; // semi-transparent primary dots
            context.fill();
          }
        });
      }
